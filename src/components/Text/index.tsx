...
const getFontFamily = (fontWeight: Pick<ITextProps, 'fontWeight'>) => {
  ...
  switch (fontWeight) {
    case 'thin': return fonts?.thin?.fontFamily
    case 'light': return fonts?.light?.fontFamily
    case 'regular': return fonts?.regular?.fontFamily
    case 'medium': return fonts?.medium?.fontFamily
    case 'bold': return fonts?.bold?.fontFamily
    default: return fonts?.regular?.fontFamily
  }
}
